FIRST_SET = {
    ...
    "<value>": ["not", "(", "piece_lit", "sip_lit", "flag_lit", "chars_lit", "id",
                ...
                "remove", "reverse", "search", "size", "sort", "sqrt", "take",
                "tochars", "topiece", "tosip", "["],
    "<notation_val>": ["piece_lit", "sip_lit", "flag_lit", "chars_lit", "append", "bill",
                       "copy", "cut", "fact", "matches", "pow", "rand", "remove",
                       "reverse", "search", "size", "sort", "sqrt", "take", "tochars",
                       "topiece", "tosip", "[", "id", "λ"],
    "<notation_val1>": ["piece_lit", "sip_lit", "flag_lit", "chars_lit", "append", "bill",
                        "copy", "cut", "fact", "matches", "pow", "rand", "remove",
                        "reverse", "search", "size", "sort", "sqrt", "take", "tochars",
                        "topiece", "tosip", "["],
    "<element_value_tail>": [",", "λ"],
    "<notation_val2>": ["id", "piece_lit", "sip_lit", "flag_lit", "chars_lit", "append",
                        "bill", "copy", "cut", "fact", "matches", "pow", "rand",
                        "remove", "reverse", "search", "size", "sort", "sqrt", "take",
                        "tochars", "topiece", "tosip", "["],
    "<id_notation_tail>": ["(", "[", ":", ",", "λ", "="],
    "<assignment_st_eq>": ["="],
    ...
    "<tail1>": ["("],
    "<built-in_rec>": ["append", "bill", "copy", "cut", "fact", "matches", "pow", "rand",
                       "remove", "reverse", "search", "size", "sort", "sqrt", "take",
                       "tochars", "topiece", "tosip"],
    "<call_tail>": ["("],
    "<dimensions>": ["["],
    ...
    "<local_id_tail>": ["of", "[", ":", "=", "+=", "-=", "*=", "/=", "%=", "("],
    "<]_tail>": ["]", "not", "(", "piece_lit", "sip_lit", "flag_lit", "chars_lit", "id",
                 "append", "bill", "copy", "cut", "fact", "matches", "pow", "rand",
                 "remove", "reverse", "search", "size", "sort", "sqrt", "take",
                 "tochars", "topiece", "tosip"],
    "<id_statements>": ["id"],
