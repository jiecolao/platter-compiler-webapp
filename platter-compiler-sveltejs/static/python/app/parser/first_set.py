FIRST_SET = {
    ...
    "<built-in_rec>": ["append", "bill", "copy", "cut", "fact", "matches", "pow",
                       "rand", "remove", "reverse", "search", "size", "sort",
                       "sqrt", "take", "tochars", "topiece", "tosip"],
    ...
    "<statements>": ["id", "append", "bill", "copy", "cut", "fact", "matches", "pow",
                     ...
                     "take", "tochars", "topiece", "tosip", "check", "menu",
                     "pass", "repeat", "order", "next", "stop", "serve", "λ"],

    "<local_id_tail>": ["of", "[", ":", "=", "+=", "-=", "*=", "/=", "%=", "("],

    "<]_tail>": ["]", "not", "(", "piece_lit", "sip_lit", "flag_lit", "chars_lit",
                 "id", "append", "bill", "copy", "cut", "fact", "matches", "pow",
                 "rand", "remove", "reverse", "search", "size", "sort", "sqrt",
